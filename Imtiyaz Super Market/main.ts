...
console.log (chalk.bgCyan.cyan.magenta.bold(
    "************************** Welcome To Imtiyaz Super Market **************************"))

let Ration_items : any = []
let Washing_items : any = []
let Sweets_items : any = []
let Furniture_items : any = []
let Clothes_items : any = []
...
if (shopping.choice == "Ration Items") {
    ...
    if (ration.item == "Floor") {
        ...
        if (choice.item == "Red Pepper") {
            let red_pepper_price : number = 650
            let contity = await inquirer.prompt (
                {
                    name : "item",
                    type : "number",
            ...
            let black_peppeer_price : number = 700
            let contity = await inquirer.prompt (
                {
                    name : "item",
                    type : "number",
            ...
            let chilli_crushed_price : number = 630
            let contity = await inquirer.prompt (
                {
                    name : "item",
                    type : "number",
